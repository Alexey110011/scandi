...
export const AddProduct = ({onAddProd=f=>f})=> {
    ...
    return (
        <div>
            ...
            <button className = "first" id ="save">SAVE</button> 
                <p>
            ...
            <div id = "DVD" ref= {DvdRef}>
                ...
                <p> Size (MB)<input type = "number" pattern = "[0-9]*" title = "Please. enter a number" name = "size" id = "size" placeholder = "number" ref ={sizeRef} required></input></p>
            </div>
            ...
            <div id = "Books" ref = {BookRef}>
                ...
                <p>
            Weight(KG)<input type = "number" pattern = "/d*" title = "Please. enter a number"bname = "weight" id = "weight" placeholder = "number" ref = {weightRef} required></input>
            </p>
            </div>
           </form>
